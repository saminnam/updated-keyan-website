        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="mt-6 space-y-5">
                    <li>
                        <a href="/about" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> About </a>
                    </li>

                    <li>
                        <a href="/services" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> Services</a>
                    </li>

                    <li>
                        <a href="/portfolio" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> Portfolio </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> Career </a>
                    </li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-2">
                ...
                <ul class="mt-6 space-y-5">
                    <li>
                        <a href="#" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> Free eBooks </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> Development Tutorial </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> How to - Blog </a>
                    </li>

                    <li>
                        <a href="#" title="" class="flex text-sm text-white transition-all duration-200 hover:text-orange-600 focus:text-orange-600"> YouTube Playlist </a>
                    </li>
                </ul>
            </div>
